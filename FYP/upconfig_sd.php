...
$id = $_POST["sd_ID"]; // 獲取使用者輸入的 sd_ID 值
$subject = $_POST["sd_Subject"]; // 獲取使用者輸入的 sd_Subject 值
$answer = $_POST["sd_Answer"]; // 獲取使用者輸入的 sd_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (sd_Photo, sd_ID, sd_Subject, sd_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("sd_Photo").addEventListener("change", function() {

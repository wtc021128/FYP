...
$id = $_POST["liiou_ID"]; // 獲取使用者輸入的 liiou_ID 值
$subject = $_POST["liiou_Subject"]; // 獲取使用者輸入的 liiou_Subject 值
$answer = $_POST["liiou_Answer"]; // 獲取使用者輸入的 liiou_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (liiou_Photo, liiou_ID, liiou_Subject, liiou_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("liiou_Photo").addEventListener("change", function() {

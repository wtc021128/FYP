...
$id = $_POST["itg_ID"]; // 獲取使用者輸入的 itg_ID 值
$subject = $_POST["itg_Subject"]; // 獲取使用者輸入的 itg_Subject 值
$answer = $_POST["itg_Answer"]; // 獲取使用者輸入的 itg_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (itg_Photo, itg_ID, itg_Subject, itg_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("itg_Photo").addEventListener("change", function() {

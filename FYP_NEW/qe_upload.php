...
$id = $_POST["QE_ID"]; // 獲取使用者輸入的 QE_ID 值
$subject = $_POST["QE_Subject"]; // 獲取使用者輸入的 QE_Subject 值
$answer = $_POST["QE_Answer"]; // 獲取使用者輸入的 QE_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO quadratic_equation (QE_Photo, QE_ID, QE_Subject, QE_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("QE_Photo").addEventListener("change", function() {

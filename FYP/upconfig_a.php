...
$id = $_POST["a_ID"]; // 獲取使用者輸入的 a_ID 值
$subject = $_POST["a_Subject"]; // 獲取使用者輸入的 a_Subject 值
$answer = $_POST["a_Answer"]; // 獲取使用者輸入的 a_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (a_Photo, a_ID, a_Subject, a_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("a_Photo").addEventListener("change", function() {

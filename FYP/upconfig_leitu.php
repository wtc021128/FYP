...
$id = $_POST["leitu_ID"]; // 獲取使用者輸入的 leitu_ID 值
$subject = $_POST["leitu_Subject"]; // 獲取使用者輸入的 leitu_Subject 值
$answer = $_POST["leitu_Answer"]; // 獲取使用者輸入的 leitu_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (leitu_Photo, leitu_ID, leitu_Subject, leitu_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("leitu_Photo").addEventListener("change", function() {

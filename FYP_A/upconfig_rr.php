...
$id = $_POST["rr_ID"]; // 獲取使用者輸入的 rr_ID 值
$subject = $_POST["rr_Subject"]; // 獲取使用者輸入的 rr_Subject 值
$answer = $_POST["rr_Answer"]; // 獲取使用者輸入的 rr_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (rr_Photo, rr_ID, rr_Subject, rr_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("rr_Photo").addEventListener("change", function() {

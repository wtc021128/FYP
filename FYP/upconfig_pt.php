...
$id = $_POST["pt_ID"]; // 獲取使用者輸入的 pt_ID 值
$subject = $_POST["pt_Subject"]; // 獲取使用者輸入的 pt_Subject 值
$answer = $_POST["pt_Answer"]; // 獲取使用者輸入的 pt_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (pt_Photo, pt_ID, pt_Subject, pt_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("pt_Photo").addEventListener("change", function() {

...
$id = $_POST["rin_ID"]; // 獲取使用者輸入的 rin_ID 值
$subject = $_POST["rin_Subject"]; // 獲取使用者輸入的 rin_Subject 值
$answer = $_POST["rin_Answer"]; // 獲取使用者輸入的 rin_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (rin_Photo, rin_ID, rin_Subject, rin_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("rin_Photo").addEventListener("change", function() {

...
<!-- <div class="container-xl">
	<div class="table-responsive"> -->
		<div class="table-wrapper">
			...
			<?php
			include 'config2.php';
			$query = 'SELECT * FROM registered_users_ac where user_type="user"';
			...
			?>
                ...
                <tr>
					...
					<td>
						<a href="update_teacher.php?id=<?php echo $result['id']; ?>" class="edit"><i class="material-icons" data-toggle="tooltip" title="Update">&#xE254;</i></a>
						<a href="teacher_delete.php?ids=<?php echo $result['id']; ?>" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
					</td>
				</tr>
			<?php
			}

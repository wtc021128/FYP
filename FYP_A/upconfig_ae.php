...
$id = $_POST["ae_ID"]; // 獲取使用者輸入的 ae_ID 值
$subject = $_POST["ae_Subject"]; // 獲取使用者輸入的 ae_Subject 值
$answer = $_POST["ae_Answer"]; // 獲取使用者輸入的 ae_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (ae_Photo, ae_ID, ae_Subject, ae_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("ae_Photo").addEventListener("change", function() {

...
$id = $_POST["loii_ID"]; // 獲取使用者輸入的 loii_ID 值
$subject = $_POST["loii_Subject"]; // 獲取使用者輸入的 loii_Subject 值
$answer = $_POST["loii_Answer"]; // 獲取使用者輸入的 loii_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (loii_Photo, loii_ID, loii_Subject, loii_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("loii_Photo").addEventListener("change", function() {

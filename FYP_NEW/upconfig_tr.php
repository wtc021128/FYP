...
$id = $_POST["tr_ID"]; // 獲取使用者輸入的 tr_ID 值
$subject = $_POST["tr_Subject"]; // 獲取使用者輸入的 tr_Subject 值
$answer = $_POST["tr_Answer"]; // 獲取使用者輸入的 tr_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (tr_Photo, tr_ID, tr_Subject, tr_Answer) VALUES (?, ?, ?, ?)';

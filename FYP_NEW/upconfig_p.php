...
$id = $_POST["p_ID"]; // 獲取使用者輸入的 p_ID 值
$subject = $_POST["p_Subject"]; // 獲取使用者輸入的 p_Subject 值
$answer = $_POST["p_Answer"]; // 獲取使用者輸入的 p_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (p_Photo, p_ID, p_Subject, p_Answer) VALUES (?, ?, ?, ?)';

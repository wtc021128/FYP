...
$id = $_POST["moct_ID"]; // 獲取使用者輸入的 moct_ID 值
$subject = $_POST["moct_Subject"]; // 獲取使用者輸入的 moct_Subject 值
$answer = $_POST["moct_Answer"]; // 獲取使用者輸入的 moct_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (moct_Photo, moct_ID, moct_Subject, moct_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("moct_Photo").addEventListener("change", function() {

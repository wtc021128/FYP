...
$id = $_POST["e_ID"]; // 獲取使用者輸入的 e_ID 值
$subject = $_POST["e_Subject"]; // 獲取使用者輸入的 e_Subject 值
$answer = $_POST["e_Answer"]; // 獲取使用者輸入的 e_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (e_Photo, e_ID, e_Subject, e_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("e_Photo").addEventListener("change", function() {

...
if(isset($_POST['update'])){
   ...
   $update_profile->execute([$name, $email, $teacher_id]);
   ...
   if(!empty($image)){
      ...
      if($image_size > 2000000){
         ...
         $update_image->execute([$image, $teacher_id]);
   ...
   if(!empty($previous_pass) || !empty($new_pass) || !empty($confirm_pass)){
      ...
      // if($previous_pass != $old_pass){
         ...
         $update_password->execute([$new_pass, $teacher_id]);
...
<section class="update-profile-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex-btn">
         ...
         <a href="teacher_index.php" class="option-btn">go back</a>
      </div>
   </form>

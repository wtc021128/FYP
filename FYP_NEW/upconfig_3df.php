...
$id = $_POST["3DF_ID"]; // 獲取使用者輸入的 3DF_ID 值
$subject = $_POST["3DF_Subject"]; // 獲取使用者輸入的 3DF_Subject 值
$answer = $_POST["3DF_Answer"]; // 獲取使用者輸入的 3DF_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (3DF_Photo, 3DF_ID, 3DF_Subject, 3DF_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("3DF_Photo").addEventListener("change", function() {

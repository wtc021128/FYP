...
$id = $_POST["C_ID"]; // 獲取使用者輸入的 C_ID 值
$subject = $_POST["C_Subject"]; // 獲取使用者輸入的 C_Subject 值
$answer = $_POST["C_Answer"]; // 獲取使用者輸入的 C_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (C_Photo, C_ID, C_Subject, C_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("C_Photo").addEventListener("change", function() {

...
if(isset($_POST['submit'])){
    ...
    $remark = mysqli_real_escape_string($conn, $_POST['remark']);
      ...
      $insertquery =  "UPDATE registered_users_ac SET usr_id ='$usr_id', usr_name ='$usr_name', email ='$email',password='$password',phone='$phone',user_type='$user_type',remark='$remark' WHERE id = $id";
...
<br>
<a href="admin_index.php">Back_Home</a>
</div>							
		...
		<div class="modal-content">
			<form method="POST" action="">
				...
				<div class="modal-footer">
					...
					<h4><a href="admin_index.php" class="button">Back_Home</a></h4>
...
// 返回到其他页面的函数
function goBack() {
    window.location.href = "admin_page.php"; // 将页面重定向到other_page.php
}
</script>
</body>
</html>

...
$id = $_POST["f_ID"]; // 獲取使用者輸入的 f_ID 值
$subject = $_POST["f_Subject"]; // 獲取使用者輸入的 f_Subject 值
$answer = $_POST["f_Answer"]; // 獲取使用者輸入的 f_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (f_Photo, f_ID, f_Subject, f_Answer) VALUES (?, ?, ?, ?)';

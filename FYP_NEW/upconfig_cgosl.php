...
$id = $_POST["cgosl_ID"]; // 獲取使用者輸入的 cgosl_ID 值
$subject = $_POST["cgosl_Subject"]; // 獲取使用者輸入的 cgosl_Subject 值
$answer = $_POST["cgosl_Answer"]; // 獲取使用者輸入的 cgosl_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (cgosl_Photo, cgosl_ID, cgosl_Subject, cgosl_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("cgosl_Photo").addEventListener("change", function() {

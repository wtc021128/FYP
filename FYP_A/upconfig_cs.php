...
$id = $_POST["cs_ID"]; // 獲取使用者輸入的 cs_ID 值
$subject = $_POST["cs_Subject"]; // 獲取使用者輸入的 cs_Subject 值
$answer = $_POST["cs_Answer"]; // 獲取使用者輸入的 cs_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (cs_Photo, cs_ID, cs_Subject, cs_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("cs_Photo").addEventListener("change", function() {

...
$id = $_POST["slcot_ID"]; // 獲取使用者輸入的 slcot_ID 值
$subject = $_POST["slcot_Subject"]; // 獲取使用者輸入的 slcot_Subject 值
$answer = $_POST["slcot_Answer"]; // 獲取使用者輸入的 slcot_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (slcot_Photo, slcot_ID, slcot_Subject, slcot_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("slcot_Photo").addEventListener("change", function() {

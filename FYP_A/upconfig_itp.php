...
$id = $_POST["itp_ID"]; // 獲取使用者輸入的 itp_ID 值
$subject = $_POST["itp_Subject"]; // 獲取使用者輸入的 itp_Subject 值
$answer = $_POST["itp_Answer"]; // 獲取使用者輸入的 itp_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (itp_Photo, itp_ID, itp_Subject, itp_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("itp_Photo").addEventListener("change", function() {

...
$id = $_POST["itc_ID"]; // 獲取使用者輸入的 itc_ID 值
$subject = $_POST["itc_Subject"]; // 獲取使用者輸入的 itc_Subject 值
$answer = $_POST["itc_Answer"]; // 獲取使用者輸入的 itc_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (itc_Photo, itc_ID, itc_Subject, itc_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("itc_Photo").addEventListener("change", function() {

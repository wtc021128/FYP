...
$id = $_POST["itae_ID"]; // 獲取使用者輸入的 itae_ID 值
$subject = $_POST["itae_Subject"]; // 獲取使用者輸入的 itae_Subject 值
$answer = $_POST["itae_Answer"]; // 獲取使用者輸入的 itae_Answer 值

// 將 Blob 和文字資料一起插入 MySQL
$sql = 'INSERT INTO calculus (itae_Photo, itae_ID, itae_Subject, itae_Answer) VALUES (?, ?, ?, ?)';
...
<script>
  // 當使用者選擇圖片時觸發事件
  document.getElementById("itae_Photo").addEventListener("change", function() {
